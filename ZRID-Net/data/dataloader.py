...
class TrainDataloader(Dataset):
    ...
    def __init__(self, haze_path, CLAHE_path, is_rotate=True, transform=None, model="train"):
        ...
        print("Total {} samples:".format(model), max(len(self.list_haze), len(self.list_CLAHE)))
...
class TestDataloader(Dataset):
    ...
    def __init__(self, haze_path, clear_path, transform=None, model="test"):
        ...
        print("Total {} samples:".format(model), max(len(self.list_haze), len(self.list_clear)))
